import { Technology, BasicResourceList, Upgrade, CompleteResourceList } from '../Classes.js';
import * as Buildings from './Buildings.js';
import * as Crafts from './Crafting.js';
import { resources } from '../PlayerInv.js';
import * as DOM from '../HTMLObjects.js';
import * as Upgrades from './Upgrades.js';

let ScavengerDroneTechBasicCost = new BasicResourceList(35, 0, 0, 0, 0, 0, 0, 0);
let DiggingBasicCost = new BasicResourceList(50, 0, 0, 0, 0, 0, 0, 0);
let MiningDroneMkITechBasicCost = new BasicResourceList(200, 0, 0, 0, 0, 0, 0, 0);
let SmeltingBasicCost = new BasicResourceList(0, 200, 0, 0, 0, 0, 0, 0);
let AssemblingMachineBasicCost = new BasicResourceList(600, 300, 100, 0, 0, 0, 0, 0);
let BasicElectrolysisBasicCost = new BasicResourceList(0, 0, 75, 0, 0, 0, 0, 0);
let MiningDroneMkIIBasicCost = new BasicResourceList(250, 0, 100, 0, 0, 0, 0, 0);
let CopperRefiningBasicCost = new BasicResourceList(0, 0, 800, 350, 0, 0, 0, 0);
let CopperWorkingBasicCost = new BasicResourceList(0, 0, 0, 1000, 150, 0, 0, 0);
let QuartzMiningBasicCost = new BasicResourceList(0, 0, 2000, 0, 1500, 0, 0, 0);
let OpticsBasicCost = new BasicResourceList(8000, 0, 4000, 0 , 3500, 10000, 0, 0);
let SiliconTechBasicCost = new BasicResourceList(8000, 0, 3000, 0, 5000, 0, 0, 0);

let ScavengerDroneTechCost = new CompleteResourceList(ScavengerDroneTechBasicCost, null, null);
let DiggingCost = new CompleteResourceList(DiggingBasicCost, null, null);
let MiningDroneMkITechCost = new CompleteResourceList(MiningDroneMkITechBasicCost, null, null);
let SmeltingCost = new CompleteResourceList(SmeltingBasicCost, null, null);
let AssemblingMachineCost = new CompleteResourceList(AssemblingMachineBasicCost, null, null);
let BasicElectrolysisCost = new CompleteResourceList(BasicElectrolysisBasicCost, null, null);
let MiningDroneMkIICost = new CompleteResourceList(MiningDroneMkIIBasicCost, null, null);0
let CopperRefiningCost = new CompleteResourceList(CopperRefiningBasicCost, null, null);0
let CopperWorkingCost = new CompleteResourceList(CopperWorkingBasicCost, null, null);
let QuartzMiningCost = new CompleteResourceList(QuartzMiningBasicCost, null, null);
let OpticsCost = new CompleteResourceList(OpticsBasicCost, null, null);
let SiliconTechCost = new CompleteResourceList(SiliconTechBasicCost, null, null);
...
let MiningDroneMkITechMethod = function(){
    ...
    resources.basicResources.ironOre.display = true;
    Smelting.unlock();
    this.disableButton();
}
...
let SmeltingMethod = function(){
    ...
    resources.basicResources.iron.display = true;
...
let AssemblingMachineMethod = function(){
    ...
    DOM.menuArray.crafting.display = true;
    Crafts.craftingList.gear.unlock();
...
let MiningDroneMkIIMethod = function(){
    ...
    resources.basicResources.copperOre.display = true;
...
let CopperRefiningMethod = function(){
    this.purchased = true;
    resources.basicResources.copper.display = true;
    Buildings.Electrolyzer.prodRate.copper.amount += 0.2;
...
let QuartzMiningMethod = function(){
    this.purchased = true;
    resources.basicResources.quartz.display = true;
...
let OpticsMethod = function(){
    ...
    resources.basicResources.bits.display = true;
    this.disableButton();
}

let SiliconTechMethod = function(){
    this.purchased = true;
    resources.basicResources.silicon.display = true;
