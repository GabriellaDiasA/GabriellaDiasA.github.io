import { Upgrade, BasicResourceList } from '../Classes.js';
...
let reinforcedDrillsCost = new BasicResourceList(0, 0, 250, 0, 0, 0, 0, 0);
let intelligentTrackingCost = new BasicResourceList(0, 0, 300, 0, 0, 0, 0, 0);
let scavengerTradeCost = new BasicResourceList(2000, 1000, 0, 0, 0, 0, 0, 0);
let droneRecyclingICost = new BasicResourceList(2500, 1500, 0, 0, 0, 0, 0, 0);
let betterSmeltingCost = new BasicResourceList(0, 500, 300, 0, 0, 0, 0, 0);
let miningCentralCost = new BasicResourceList(10000, 0, 0, 0, 0, 0, 0, 0);
let copperSmeltingCost = new BasicResourceList(3000, 1500, 500, 0, 0, 0, 0, 0);
let silosCost = new BasicResourceList(2000, 1250, 0, 1000, 0, 0, 0, 0);
let advancedDroneCircuitryCost = new BasicResourceList(2000, 0, 0, 0, 750, 0, 0, 0);
let intelligentPathfindingCost = new BasicResourceList(3500, 0, 2000, 0, 1500, 0, 0, 0);
let oscillatorsCost = new BasicResourceList(4000, 0, 2000, 0, 2500, 8000, 0, 0);
let quartzProcessingCost = new BasicResourceList(6500, 0, 2500, 0, 3500, 0, 0, 0);
