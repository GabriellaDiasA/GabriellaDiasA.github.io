...
export const buildingList = {
    ...
    smelter: new Building({
        ...
        price: resourceListFactory({
            scrap: new Resource({ label: "Scrap", amount: 200 }),
            ironOre: new Resource({ label: "Iron Ore", amount: 35 })
        }),
        priceRate: 1.2,
        production: resourceListFactory({
            ironOre: new Resource({ label: "Iron Ore", amount: -0.1 }),
            iron: new Resource({ label: "Iron", amount: 0.1 })
        })
    })
}
